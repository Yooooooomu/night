<?php
  ...
  $db = [
	[
	  "vid" => 1,
	  "product_name" => "和菓子1",
	  "video_poster" => "https://bi09fclg.qcloud.la/img/video1.png",
	  ...
	  "video_title" => "日式三色和菓子1",
	  
	  "video_baike" => "“和菓子”，“和”指代日本。“菓子”一词指代甜点。中文写作“和果子”。<br><br>我们所说的和果子，其实指的是日式糕点。<br><br>日式糕点和日本料理一样，对于原料、制作、出品外观和不可食用的食具、装饰品都非常讲究。其造型通常为花、叶、桃、可爱的小动物、传统用具等。<br><br>本次介绍的日式三色和果子，也叫三色团子。属于春天赏樱花的时候看的花见团子，一般是三色的。<br><br>它的主要材料是：嫩豆腐，白玉粉，白砂糖，抹茶粉，红豆沙",
